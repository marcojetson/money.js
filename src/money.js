(function (context) {
     ...
     */
    var Currency = function (currencyCode) {
        currencyCode = currencyCode.toUpperCase();

        if (!Currency.currencies[currencyCode]) {
     ...
     */
    Currency.addCurrency = function (code, displayName, numericCode, defaultFractionDigits, subUnit) {
    ...
    Currency.prototype.getDefaultFractionDigits = function () {
        return Currency.currencies[this.currencyCode].default_fraction_digits;
    };

    /**
     * @return {string}
     */
    Currency.prototype.getDisplayName = function () {
        return Currency.currencies[this.currencyCode].display_name;
    };

    /**
     * @return {integer}
     */
    Currency.prototype.getNumericCode = function () {
        return Currency.currencies[this.currencyCode].numeric_code;
    };

    /**
     * @return {integer}
     */
    Currency.prototype.getSubUnit = function () {
        return Currency.currencies[this.currencyCode].sub_unit;
    };
     ...
     * @return {Money}
     */
    Money.fromString = function (value, currency) {
        ...
        return new Money(
            parseInt(
                Math.round(
                    currency.getSubUnit() * parseFloat(value).toFixed(currency.getDefaultFractionDigits())
                ),
            10),
            currency
        );
     ...
     * @param {Money} money
     */
    Money.prototype.assertSameCurrency = function (money) {
        if (this.currency.getCurrencyCode() != money.currency.getCurrencyCode()) {
     ...
     * @return {float}
     */
    Money.prototype.getConvertedAmount = function () {
        return parseFloat(this.amount / this.currency.getSubUnit()).toFixed(this.currency.getDefaultFractionDigits());
    };
    ...
    Money.prototype.add = function (money) {
        ...
        return this.newMoney(this.amount + money.getAmount());
    };
    ...
    Money.prototype.multiply = function (factor) {
        return this.newMoney(Math.round(factor * this.amount));
    };
     ...
     * @return {object}
     */
    Money.prototype.extractPercentage = function (percentage) {
        percentage = this.newMoney(Math.round(this.amount / (100 + percentage) * percentage), this.currency);
     ...
     * @return {array}
     */
    Money.prototype.allocateToTargets = function (n) {
        if (Number(n) !== n || n % 1 > 0) {
            throw new Error('n must be an integer');
        }

        var low = this.newMoney(parseInt(this.amount / n), 10),
     ...
     * @return {array}
     */
    Money.prototype.allocateByRatios = function (ratios) {
        var result = [],
            total = 0,
        ...
        for (var i = 0; i < ratios.length; i++) {
            amount = parseInt(this.amount * ratios[i] / total);
            result.push(this.newMoney(amount));
            remainder -= amount;
        }
     ...
     * @return {boolean}
     */
    Money.prototype.greaterThan = function (money) {
     ...
     * @return {boolean}
     */
    Money.prototype.greaterThanOrEqual = function (money) {
     ...
     * @return {boolean}
     */
    Money.prototype.lessThan = function (money) {
        return this.compareTo(money) === -1;
    };
     ...
     * @return {boolean}
     */
    Money.prototype.lessThanOrEqual = function (money) {
    ...
    for (var currency in Currency.currencies) {
        (function (currency) {
            context[currency] = function (amount) {
